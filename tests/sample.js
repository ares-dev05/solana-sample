...
describe("sample", () => {
  ...
  it("Creates and initializes an account in a single atomic transaction (simplified)", async () => {
    ...
    const programId = new anchor.web3.PublicKey("59o6eG5iMJYA9jfDt1txnEuHv2k8Dnpo2kxbBmCoHVfZ");
  ...
  it("Decrement", async () => {
    ...
    //Address of the deployed program
    const programId = new anchor.web3.PublicKey("59o6eG5iMJYA9jfDt1txnEuHv2k8Dnpo2kxbBmCoHVfZs");
